...
(function() {
  $(function() {
    var $body, $collection, $grid, $header, $itemTitle, $main, $pageTitle, $secondary, $single, $table, $window, createSingle, dragAndDrop, holdOn, horzScroll, init, loadSingle, lookAt, lookAway, pickUp, putDown, resizeGrid, resizeSects, scrolls, tableScroll, transEnd, vertScroll;
    $window = $(window);
    $body = $('body');
    $main = $('main');
    $header = $('header');
    ...
    pickUp = function(self) {
      ...
      setTimeout(function() {
        return $itemTitle.addClass('show');
      }, 1);
      setTimeout(function() {
    ...
    putDown = function() {
      ...
      $itemTitle.on(transEnd, function() {
        $itemTitle.off(transEnd);
        return $itemTitle.removeClass('ready');
      });
