...
(function() {
  $(function() {
    var $body, $collection, $collectionItems, $grid, $header, $itemTitle, $main, $pageTitle, $secondary, $single, $table, $window, browseCollection, browserNav, buildGrid, checkSize, closeDur, createCollectionItem, createSingle, doodle, dragAndDrop, holdOn, horzScroll, init, insertCollection, loadCollection, loadSingle, loadedSlug, lookAt, lookAway, makeResizable, openDur, pickUp, putDown, resizeFolder, resizeGrid, saveCollection, scrollInterval, scrollShift, shiftAndRotate, toggleFolder, transEnd, vertScroll;
    $window = $(window);
    $body = $('body');
    $main = $('main');
    $header = $('header');
    ...
    insertCollection = function(collection, story) {
      return $.each(collection, function(i, slug) {
        ...
        if ($item.length) {
          return holdOn($item.clone(), false);
        } else {
    ...
    createCollectionItem = function(item, story) {
      ...
      return $.ajax({
        ...
        success: function(item, status, jqXHR) {
          ...
          return $collectionItems.append($item);
        }
      });
    };
    ...
    browseCollection = function(e) {
      var colWidth, marginLeft, mouse, mouseShift, offset, winWidth;
      mouse = e.clientX;
      ...
      return console.log('winWidth: ' + winWidth + ' colWidth: ' + colWidth + ' mouseShift: ' + mouseShift + ' marginLeft: ' + marginLeft);
    };
    doodle = function() {
      var allMarks, i, j;
      return;
