...
(function() {
  $(function() {
    var $body, $collection, $grid, $header, $main, $single, $subtitle, $table, $window, createSingle, dragAndDrop, holdOn, horzScroll, init, loadSingle, lookAt, lookAway, pickUp, putDown, resizeGrid, resizeSects, scrolls, tableScroll, transEnd, vertScroll;
    $window = $(window);
    $body = $('body');
    $main = $('main');
    $header = $('header');
